<x-guest-layout>
    <div class="mb-6 text-center">
        ...
        <p class="mt-2 text-sm text-gray-600">Cadastre-se para começar a usar o sistema</p>
    </div>
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div>
            ...
            <x-text-input id="name" class="block mt-1 w-full" type="text" name="name" :value="old('name')" required autofocus autocomplete="name" placeholder="Digite seu nome completo" />
