<x-app-layout>
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="mb-6">
            <h1 class="text-3xl font-bold text-gray-900">Nova Tag</h1>
            <p class="mt-1 text-sm text-gray-600">Crie uma nova etiqueta para categorizar seus alunos</p>
        </div>

        <x-card>
            <form method="POST" action="{{ route('tags.store') }}" x-data="{ cor: '#3b82f6' }">
                @csrf
